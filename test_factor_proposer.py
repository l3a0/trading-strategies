...
from factor_grammar import enumerate_exprs
from read_gate_wire import FACTOR_PROPOSAL_FIELDS, ProposalBatch
...
class TestExprSerialization:
    ...
    def test_dict_to_expr_raises_on_malformed(self) -> None:
        from factor_grammar import ExprGrammarError
...
class TestGate:
    ...
    def test_dedups_against_tried_and_within_batch(self) -> None:
        fb = _backend()
        from factor_grammar import canonical_expr_key
