...
GEN_LEDGER_PATH = 'gen_ledger.jsonl'
...
def _composition_slice(n_singles: int, n_doubles: int) -> list:
    ...
    from generative_grammar import enumerate_compositions
...
def run_generative_search(tickers: tuple[str, ...] | None = None, *,
    ...
    from edge_search import (STRUCTURE_CAPITAL, STRUCTURE_END, STRUCTURE_SEARCH, _data_lineage_hash,
                             _load_ticker_data, load_idea_ledger, search_saturation)
    from generative_engine import (judge_compositions_against_published, record_compositions,
                                   score_composition)
...
def main() -> None:
    import sys
    from edge_search import format_saturation
