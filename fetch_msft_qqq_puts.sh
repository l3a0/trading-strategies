...
fetch_one() {  # $1=ticker $2=out $3=dates-from $4=start $5=end
  ...
  while true; do
    ...
    ./.venv/bin/python download_option_dailies.py --ticker $tk --keep put \
...
fetch_one MSFT msft_option_dailies_puts.csv msft_20yr_prices.csv 2010-05-10 2026-04-10
fetch_one QQQ  qqq_option_dailies_puts.csv  qqq_20yr_prices.csv  2011-03-23 2026-06-05
