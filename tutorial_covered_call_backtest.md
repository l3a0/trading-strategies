...
The full implementation is [`cc_backtest.py::compute_statistics`](https://github.com/l3a0/trading-strategies/blob/main/engine/cc_backtest.py#L612). Signature:
