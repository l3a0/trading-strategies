...
def main() -> None:
    spy_days, spy = run_put(data_path('spy_option_dailies_puts.csv'), 'SPY')
    report('SPY', spy_days, spy)
    iwm_days, iwm = run_put(data_path('iwm_option_dailies.csv'), 'IWM')
    ...
    sd, sstr = run_straddle([data_path('spy_option_dailies.csv'), data_path('spy_option_dailies_puts.csv')], 'SPY')
    report_straddle('SPY', sd, sstr)
    idd, istr = run_straddle([data_path('iwm_option_dailies.csv')], 'IWM')
