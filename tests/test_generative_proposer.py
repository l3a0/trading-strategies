...
def onboarded_two(monkeypatch):
    ...
    monkeypatch.setattr('generative.generative_proposer._is_onboarded', lambda t: t in {_SEARCH, _SEARCH2})
...
class TestGateCompositions:
    ...
    def test_tried_keys_excludes_a_published_cell(self, onboarded_two) -> None:
        from generative.generative_grammar import canonical_key
